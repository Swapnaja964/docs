...
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------|                                                     
| `Image` file                                                                             | <ResponseField name="required" type="string"></ResponseField>                             |                 
| <Tooltip tip="Copy to clipboard">`output_type`</Tooltip> enum<string>                    | <ResponseField name="required" type="string"></ResponseField>                             |
| <LaTeX> Allowed values: <Tooltip tip=|Enums   | description |>`JSON`</Tooltip></Latex>   |                                                                                           |
