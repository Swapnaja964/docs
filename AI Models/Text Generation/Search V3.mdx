---
title: 'Search V3'
openapi: 'POST https://api.worqhat.com/api/ai/search/v3/{modelId}'
---
...
By analyzing user content with sophisticated algorithms, the Search V3 model extracts key concepts and relationships to deliver relevant results. It accounts for language nuances such as synonyms, word variations, and typos to ensure robust search accuracy.
...
You can use the following Endpoints on any Codebase, including client-side codebases as long as you can send the Headers and the Request Body to the API Endpoint. It's that easy! Just send a POST Request to the API Endpoint with the Headers and the Request Body, and you are good to go!
...
The Search V3 AI is trained on extensive datasets to understand word meanings and their relationships. However, this model is primarily focused on optimizing response times and providing quicker, meaning-based answers to user queries.
