---
title: 'Finetuned Models (Text Only)'
---
...
* Fetch real world information and data using the [Alpha Models(Text Only)](AI Models/Text Generation/Alpha Models (Text Only))