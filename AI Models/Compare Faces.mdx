...
<AccordionGroup>
    ...
    Example `Authorization: Bearer Authorization: Bearer 2f68dbbf-519d-4f01-9636-e2421b68f379`
  </Accordion>
</AccordionGroup>

| Body Params                                                                                 |  `multipart/form-data`                                                                    |
| ----------------------------------------------------------------------------------------    | ------------------------------------------------------------------------------------------|                                                     
| `Source_image` file                        <ResponseField name="required"></ResponseField>  |                                                                                           |
| `target_image` file                        <ResponseField name="required"></ResponseField>  |                                                                                           |
