...
openapi: POST https://api.worqhat.com/api/ai/images/v2/face-detection
---
...
| ----------------------------------------------------------------------------------------    | ------------------------------------------------------------------------------------------|                                                     
| `Image` file                        <ResponseField name="required"></ResponseField>         |                                                                                           |
|  Example:`file:///Users/sagnikghosh/Downloads/WhatsApp Image 2023-09-21 at 10.45.35 AM.jpeg`|                                                                                           |
